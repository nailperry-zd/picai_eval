...
def extract_lesion_candidates_static(
    ...
    print(f"Extract lesion candidates threshold = {threshold}")
...
def extract_lesion_candidates_dynamic(
    ...
    print(f"extracting results dynamic_hard_blobs={np.unique(dynamic_hard_blobs)}")
    print(f"extracting results confidences={np.unique(confidences)}")
    print(f"extracting results dynamic_indexed_blobs={np.unique(dynamic_indexed_blobs)}")
